...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'watercolor-btn',
      secondary: 'bg-white text-clay-700 border-2 border-clay-300 hover:bg-clay-50 shadow-paper',
      ghost: 'text-clay-700 hover:bg-clay-100',
      danger: 'bg-red-600 text-white hover:bg-red-700 shadow-watercolor',
    }
